  ...
  <div class="container">
    <div class="row">
      <?php
          ...
          // Store the number of users and authors in a variable by counting the number of rows in the result
          $no_of_users = mysqli_num_rows(mysqli_query($con, "SELECT * FROM user"));
          $no_of_authors = mysqli_num_rows(mysqli_query($con, "SELECT * FROM author"));
