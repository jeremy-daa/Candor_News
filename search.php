...
<section class="search-box">
  <div class="container p-2">
    <form method="GET" class="search-article d-flex">
      <div class="box-container d-flex" style="width:500px;justify-content:space-between">
        ...
        <button type="submit" name="search" class="btn btn-primary" style="width:70px;margin-right:-12px;border-radius: 0px 25px 25px 0px;">          
          <i id="search-icon" class="fas fa-search" style="color:white;"></i>
        </button>
      </div>
      <div class="filters">
        ...
        if($row  > 0) {
          ...
          while($data = mysqli_fetch_assoc($searchResult)) {
            ...
            createArticleCard($article_title, $article_image, 
                ...
                $category_color, $new, $article_trend);
          }
        }
        ...
        <div class="pagination">
          <?php
            ...
            for($i = 1; $i <= $total_page; $i++) {
              ...
              echo '<a href="search.php?page='.$i.'&category_select='.$cat_id.'&name='.$name.'&trending='.$trending.'" class="'.$active.'">'.$i.'</a>';
            }
